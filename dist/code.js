...
figma.ui.onmessage = (msg) => __awaiter(undefined, void 0, void 0, function* () {
    if (msg.type === 'init') {
        ...
        lodash_mergeWith__WEBPACK_IMPORTED_MODULE_1___default()(newState, msg.initialState, savedState, (objValue, srcValue) => {
            if (lodash_isArray__WEBPACK_IMPORTED_MODULE_0___default()(objValue) && lodash_isArray__WEBPACK_IMPORTED_MODULE_0___default()(srcValue)) {
                return srcValue;
            }
        });
    ...
    if (msg.type === 'run') {
        ...
        if (nodes.length <= 1) {
            figma.notify('I need two or more text elements to sort 🤦');
            return;
        }
        nodes.map(node => {
            if (node.type !== 'TEXT') {
                figma.notify('This only works on text 🤦');
                return;
            }
        });
        ...
        textNodes.map((node, index) => __awaiter(this, void 0, void 0, function* () {
